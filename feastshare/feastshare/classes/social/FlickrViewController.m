...
- (void)viewDidLoad
{
    ...
    //[super viewDidLoad];
    NSString *urlAddress = @"http://www.flickr.com/auth-72157631693341994";
    ...
    [FlickrWebView loadRequest:requestObj];
}
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    NSLog(@"!!! FlickrViewController didFailLoadWithError: %@", [error description]);
    [self showMainApp];
}
...
- (void) viewWillDisappear {
    if ([FlickrWebView isLoading]) {
        [FlickrWebView stopLoading];
    }
}
